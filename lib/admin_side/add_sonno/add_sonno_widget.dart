...
import 'add_sonno_model.dart';
export 'add_sonno_model.dart';

class AddSonnoWidget extends StatefulWidget {
  const AddSonnoWidget({super.key});

  @override
  State<AddSonnoWidget> createState() => _AddSonnoWidgetState();
}

class _AddSonnoWidgetState extends State<AddSonnoWidget> {
  late AddSonnoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddSonnoModel());
            ...
            children: [
              if (_model.dropDownValue == 'Sonno')
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'ADD_SONNO_REGISTRARE_IL_CAPITOLO_BTN_ON_');
                    ...
                    _model.newCatSonno = LessonsRecord.getDocumentFromData({
                      ...createLessonsRecordData(
                        title: _model.textController.text,
                        premium: _model.switchListTileValue,
                        category: _model.dropDownValue,
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('ADD_SONNO_COMP_CHUIDI_BTN_ON_TAP');
                  logFirebaseEvent('Button_bottom_sheet');
                  Navigator.pop(context);
                },
                text: 'Chuidi',
