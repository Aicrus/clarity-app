...
import 'sonno_pratiaca_audio_adder_model.dart';
export 'sonno_pratiaca_audio_adder_model.dart';

class SonnoPratiacaAudioAdderWidget extends StatefulWidget {
  const SonnoPratiacaAudioAdderWidget({
    super.key,
  ...
  @override
  State<SonnoPratiacaAudioAdderWidget> createState() =>
      _SonnoPratiacaAudioAdderWidgetState();
}

class _SonnoPratiacaAudioAdderWidgetState
    extends State<SonnoPratiacaAudioAdderWidget> {
  late SonnoPratiacaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SonnoPratiacaAudioAdderModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'SONNO_PRATIACA_AUDIO_ADDER_SELEZIONARE_I');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'SONNO_PRATIACA_AUDIO_ADDER_AGGIUNGI_UN\'');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'SONNO_PRATIACA_AUDIO_ADDER_REGISTRARE_IL');
                      logFirebaseEvent('Button_backend_call');

                      var audioPraticaSonnoRecordReference =
                          AudioPraticaSonnoRecord.collection.doc();
                      await audioPraticaSonnoRecordReference.set({
                        ...createAudioPraticaSonnoRecordData(
                          title: _model.textController1.text,
                          length: _model.textController2.text,
                          index: int.tryParse(_model.textController3.text),
                          lessonTypeRef: widget.parameter1,
                          audioPratica: _model.uploadedFileUrl1,
                      ...
                      _model.listPotRef =
                          AudioPraticaSonnoRecord.getDocumentFromData({
                        ...createAudioPraticaSonnoRecordData(
                          title: _model.textController1.text,
                          length: _model.textController2.text,
                          index: int.tryParse(_model.textController3.text),
                      ...
                      }, audioPraticaSonnoRecordReference);
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'SONNO_PRATIACA_AUDIO_ADDER_CHIUDERE_BTN_');
                      logFirebaseEvent('Button_bottom_sheet');
                      Navigator.pop(context);
                    },
                    text: 'Chiudere',
