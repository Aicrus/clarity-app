...
import 'potenzia_ascolti_audio_text_editor_model.dart';
export 'potenzia_ascolti_audio_text_editor_model.dart';

class PotenziaAscoltiAudioTextEditorWidget extends StatefulWidget {
  const PotenziaAscoltiAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AscoltiPotenziaRecord? docMedita;

  @override
  State<PotenziaAscoltiAudioTextEditorWidget> createState() =>
      _PotenziaAscoltiAudioTextEditorWidgetState();
}

class _PotenziaAscoltiAudioTextEditorWidgetState
    extends State<PotenziaAscoltiAudioTextEditorWidget> {
  late PotenziaAscoltiAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PotenziaAscoltiAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_ASCOLTI_AUDIO_TEXT_EDITOR_DISMI');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_ASCOLTI_AUDIO_TEXT_EDITOR_SAVE_');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAscoltiPotenziaRecordData(
