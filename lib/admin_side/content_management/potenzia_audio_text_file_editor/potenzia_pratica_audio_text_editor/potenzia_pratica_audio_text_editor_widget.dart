...
import 'potenzia_pratica_audio_text_editor_model.dart';
export 'potenzia_pratica_audio_text_editor_model.dart';

class PotenziaPraticaAudioTextEditorWidget extends StatefulWidget {
  const PotenziaPraticaAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AudioPraticaPotenziaRecord? docMedita;

  @override
  State<PotenziaPraticaAudioTextEditorWidget> createState() =>
      _PotenziaPraticaAudioTextEditorWidgetState();
}

class _PotenziaPraticaAudioTextEditorWidgetState
    extends State<PotenziaPraticaAudioTextEditorWidget> {
  late PotenziaPraticaAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PotenziaPraticaAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_PRATICA_AUDIO_TEXT_EDITOR_DISMI');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_PRATICA_AUDIO_TEXT_EDITOR_SAVE_');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAudioPraticaPotenziaRecordData(
