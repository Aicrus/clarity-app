...
import 'potenzia_teoria_audio_text_editor_model.dart';
export 'potenzia_teoria_audio_text_editor_model.dart';

class PotenziaTeoriaAudioTextEditorWidget extends StatefulWidget {
  const PotenziaTeoriaAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AudioTeoriaPotenziaRecord? docMedita;

  @override
  State<PotenziaTeoriaAudioTextEditorWidget> createState() =>
      _PotenziaTeoriaAudioTextEditorWidgetState();
}

class _PotenziaTeoriaAudioTextEditorWidgetState
    extends State<PotenziaTeoriaAudioTextEditorWidget> {
  late PotenziaTeoriaAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PotenziaTeoriaAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_TEORIA_AUDIO_TEXT_EDITOR_DISMIS');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('POTENZIA_TEORIA_AUDIO_TEXT_EDITOR_SAVE_B');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAudioTeoriaPotenziaRecordData(
