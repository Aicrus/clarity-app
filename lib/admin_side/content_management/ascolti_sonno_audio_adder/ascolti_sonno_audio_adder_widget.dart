...
import 'ascolti_sonno_audio_adder_model.dart';
export 'ascolti_sonno_audio_adder_model.dart';

class AscoltiSonnoAudioAdderWidget extends StatefulWidget {
  const AscoltiSonnoAudioAdderWidget({
    super.key,
  ...
  @override
  State<AscoltiSonnoAudioAdderWidget> createState() =>
      _AscoltiSonnoAudioAdderWidgetState();
}

class _AscoltiSonnoAudioAdderWidgetState
    extends State<AscoltiSonnoAudioAdderWidget> {
  late AscoltiSonnoAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AscoltiSonnoAudioAdderModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_SONNO_AUDIO_ADDER_SELEZIONARE_IL');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_SONNO_AUDIO_ADDER_AGGIUNGI_UN\'I');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_SONNO_AUDIO_ADDER_REGISTRARE_IL_');
                        logFirebaseEvent('Button_backend_call');

                        var ascoltiSonnoRecordReference =
                            AscoltiSonnoRecord.collection.doc();
                        await ascoltiSonnoRecordReference.set({
                          ...createAscoltiSonnoRecordData(
                        ...
                        _model.listPotRef =
                            AscoltiSonnoRecord.getDocumentFromData({
                          ...createAscoltiSonnoRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_SONNO_AUDIO_ADDER_CHIUDERE_BTN_O');
                        logFirebaseEvent('Button_bottom_sheet');
                        Navigator.pop(context);
                      },
                      text: 'Chiudere',
