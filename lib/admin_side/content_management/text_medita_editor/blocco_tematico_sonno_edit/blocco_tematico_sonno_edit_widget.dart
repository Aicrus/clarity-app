...
import 'blocco_tematico_sonno_edit_model.dart';
export 'blocco_tematico_sonno_edit_model.dart';

class BloccoTematicoSonnoEditWidget extends StatefulWidget {
  const BloccoTematicoSonnoEditWidget({
    super.key,
  ...
  @override
  State<BloccoTematicoSonnoEditWidget> createState() =>
      _BloccoTematicoSonnoEditWidgetState();
}

class _BloccoTematicoSonnoEditWidgetState
    extends State<BloccoTematicoSonnoEditWidget> {
  late BloccoTematicoSonnoEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BloccoTematicoSonnoEditModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('BLOCCO_TEMATICO_SONNO_EDIT_DISMISS_BTN_O');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('BLOCCO_TEMATICO_SONNO_EDIT_SAVE_BTN_ON_T');
