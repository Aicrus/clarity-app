...
import 'medita_lesson_text_field_editor_model.dart';
export 'medita_lesson_text_field_editor_model.dart';

class MeditaLessonTextFieldEditorWidget extends StatefulWidget {
  const MeditaLessonTextFieldEditorWidget({
    super.key,
    required this.docMedita,
  });

  final MeditazioneRecord? docMedita;

  @override
  State<MeditaLessonTextFieldEditorWidget> createState() =>
      _MeditaLessonTextFieldEditorWidgetState();
}

class _MeditaLessonTextFieldEditorWidgetState
    extends State<MeditaLessonTextFieldEditorWidget> {
  late MeditaLessonTextFieldEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaLessonTextFieldEditorModel());
    ...
    _model.subTitleController ??=
        TextEditingController(text: widget.docMedita?.susubtitle);
    _model.subTitleFocusNode ??= FocusNode();

    _model.indexController1 ??=
        TextEditingController(text: widget.docMedita?.day);
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_LESSON_TEXT_FIELD_EDITOR_DISMISS_');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_LESSON_TEXT_FIELD_EDITOR_SAVE_BTN');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createMeditazioneRecordData(
