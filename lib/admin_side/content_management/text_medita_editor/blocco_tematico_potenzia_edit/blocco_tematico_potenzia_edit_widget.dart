...
import 'blocco_tematico_potenzia_edit_model.dart';
export 'blocco_tematico_potenzia_edit_model.dart';

class BloccoTematicoPotenziaEditWidget extends StatefulWidget {
  const BloccoTematicoPotenziaEditWidget({
    super.key,
  ...
  @override
  State<BloccoTematicoPotenziaEditWidget> createState() =>
      _BloccoTematicoPotenziaEditWidgetState();
}

class _BloccoTematicoPotenziaEditWidgetState
    extends State<BloccoTematicoPotenziaEditWidget> {
  late BloccoTematicoPotenziaEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BloccoTematicoPotenziaEditModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('BLOCCO_TEMATICO_POTENZIA_EDIT_DISMISS_BT');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('BLOCCO_TEMATICO_POTENZIA_EDIT_SAVE_BTN_O');
