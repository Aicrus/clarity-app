...
import 'medita_pratiaca_audio_adder_model.dart';
export 'medita_pratiaca_audio_adder_model.dart';

class MeditaPratiacaAudioAdderWidget extends StatefulWidget {
  const MeditaPratiacaAudioAdderWidget({
    super.key,
  ...
  @override
  State<MeditaPratiacaAudioAdderWidget> createState() =>
      _MeditaPratiacaAudioAdderWidgetState();
}

class _MeditaPratiacaAudioAdderWidgetState
    extends State<MeditaPratiacaAudioAdderWidget> {
  late MeditaPratiacaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaPratiacaAudioAdderModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'MEDITA_PRATIACA_AUDIO_ADDER_SELEZIONARE_');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'MEDITA_PRATIACA_AUDIO_ADDER_REGISTRARE_I');
                      logFirebaseEvent('Button_backend_call');

                      var audioPraticaRecordReference =
                          AudioPraticaRecord.collection.doc();
                      await audioPraticaRecordReference.set({
                        ...createAudioPraticaRecordData(
                          title: _model.textController1.text,
                          length: _model.textController2.text,
                          index: int.tryParse(_model.textController3.text),
                          lessonTypeRef: widget.parameter1,
                          audioPratica: _model.uploadedFileUrl,
                        ),
                        ...mapToFirestore(
                          {
                      ...
                      _model.listMedRefe =
                          AudioPraticaRecord.getDocumentFromData({
                        ...createAudioPraticaRecordData(
                          title: _model.textController1.text,
                          length: _model.textController2.text,
                          index: int.tryParse(_model.textController3.text),
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'MEDITA_PRATIACA_AUDIO_ADDER_CHIUDERE_BTN');
                      logFirebaseEvent('Button_bottom_sheet');
                      Navigator.pop(context);
                    },
                    text: 'Chiudere',
