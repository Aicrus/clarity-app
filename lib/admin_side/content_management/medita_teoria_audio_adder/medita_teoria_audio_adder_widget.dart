...
import 'medita_teoria_audio_adder_model.dart';
export 'medita_teoria_audio_adder_model.dart';

class MeditaTeoriaAudioAdderWidget extends StatefulWidget {
  const MeditaTeoriaAudioAdderWidget({
    super.key,
  ...
  @override
  State<MeditaTeoriaAudioAdderWidget> createState() =>
      _MeditaTeoriaAudioAdderWidgetState();
}

class _MeditaTeoriaAudioAdderWidgetState
    extends State<MeditaTeoriaAudioAdderWidget> {
  late MeditaTeoriaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaTeoriaAudioAdderModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MEDITA_TEORIA_AUDIO_ADDER_SELEZIONARE_IL');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MEDITA_TEORIA_AUDIO_ADDER_AGGIUNGI_UN\'I');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MEDITA_TEORIA_AUDIO_ADDER_REGISTRARE_IL_');
                        logFirebaseEvent('Button_backend_call');

                        var audioTeoriaRecordReference =
                            AudioTeoriaRecord.collection.doc();
                        await audioTeoriaRecordReference.set({
                          ...createAudioTeoriaRecordData(
                        ...
                        _model.listMedRef =
                            AudioTeoriaRecord.getDocumentFromData({
                          ...createAudioTeoriaRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'MEDITA_TEORIA_AUDIO_ADDER_CHIUDERE_BTN_O');
                        logFirebaseEvent('Button_bottom_sheet');
                        Navigator.pop(context);
                      },
                      text: 'Chiudere',
