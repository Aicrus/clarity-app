...
import 'sonno_teoria_audio_adder_model.dart';
export 'sonno_teoria_audio_adder_model.dart';

class SonnoTeoriaAudioAdderWidget extends StatefulWidget {
  const SonnoTeoriaAudioAdderWidget({
    super.key,
  ...
  @override
  State<SonnoTeoriaAudioAdderWidget> createState() =>
      _SonnoTeoriaAudioAdderWidgetState();
}

class _SonnoTeoriaAudioAdderWidgetState
    extends State<SonnoTeoriaAudioAdderWidget> {
  late SonnoTeoriaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SonnoTeoriaAudioAdderModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SONNO_TEORIA_AUDIO_ADDER_SELEZIONARE_IL_');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SONNO_TEORIA_AUDIO_ADDER_AGGIUNGI_UN\'IM');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SONNO_TEORIA_AUDIO_ADDER_REGISTRARE_IL_C');
                        logFirebaseEvent('Button_backend_call');

                        var audioTeoriaSonnoRecordReference =
                            AudioTeoriaSonnoRecord.collection.doc();
                        await audioTeoriaSonnoRecordReference.set({
                          ...createAudioTeoriaSonnoRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                            lessonTypeRef: widget.parameter1,
                            audioTeoria: _model.uploadedFileUrl1,
                        ...
                        _model.listSonRef =
                            AudioTeoriaSonnoRecord.getDocumentFromData({
                          ...createAudioTeoriaSonnoRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                        ...
                        }, audioTeoriaSonnoRecordReference);
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SONNO_TEORIA_AUDIO_ADDER_CHIUDERE_BTN_ON');
                        logFirebaseEvent('Button_bottom_sheet');
                        Navigator.pop(context);
                      },
                      text: 'Chiudere',
