...
import 'ascolti_pot_audio_adder_model.dart';
export 'ascolti_pot_audio_adder_model.dart';

class AscoltiPotAudioAdderWidget extends StatefulWidget {
  const AscoltiPotAudioAdderWidget({
    super.key,
  ...
  @override
  State<AscoltiPotAudioAdderWidget> createState() =>
      _AscoltiPotAudioAdderWidgetState();
}

class _AscoltiPotAudioAdderWidgetState
    extends State<AscoltiPotAudioAdderWidget> {
  late AscoltiPotAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AscoltiPotAudioAdderModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_POT_AUDIO_ADDER_SELEZIONARE_IL_F');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_POT_AUDIO_ADDER_AGGIUNGI_UN\'IMM');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_POT_AUDIO_ADDER_AGGIUNGERE_L\'AU');
                        logFirebaseEvent('Button_backend_call');

                        var ascoltiPotenziaRecordReference =
                            AscoltiPotenziaRecord.collection.doc();
                        await ascoltiPotenziaRecordReference.set({
                          ...createAscoltiPotenziaRecordData(
                        ...
                        _model.listPotRef =
                            AscoltiPotenziaRecord.getDocumentFromData({
                          ...createAscoltiPotenziaRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                        ...
                        }, ascoltiPotenziaRecordReference);
                      ...
                      text: 'Aggiungere l\'audio alla lezione',
                      options: FFButtonOptions(
                        width: 350.0,
                        height: 56.0,
                        padding: const EdgeInsets.all(0.0),
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ASCOLTI_POT_AUDIO_ADDER_CHIUDERE_BTN_ON_');
                        logFirebaseEvent('Button_bottom_sheet');
                        Navigator.pop(context);
                      },
                      text: 'Chiudere',
