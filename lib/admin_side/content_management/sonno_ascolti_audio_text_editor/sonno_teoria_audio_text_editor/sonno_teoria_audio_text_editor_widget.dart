...
import 'sonno_teoria_audio_text_editor_model.dart';
export 'sonno_teoria_audio_text_editor_model.dart';

class SonnoTeoriaAudioTextEditorWidget extends StatefulWidget {
  const SonnoTeoriaAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AudioTeoriaSonnoRecord? docMedita;

  @override
  State<SonnoTeoriaAudioTextEditorWidget> createState() =>
      _SonnoTeoriaAudioTextEditorWidgetState();
}

class _SonnoTeoriaAudioTextEditorWidgetState
    extends State<SonnoTeoriaAudioTextEditorWidget> {
  late SonnoTeoriaAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SonnoTeoriaAudioTextEditorModel());
        ...
        children: [
          Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                labelText: widget.docMedita?.title,
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SONNO_TEORIA_AUDIO_TEXT_EDITOR_DISMISS_B');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SONNO_TEORIA_AUDIO_TEXT_EDITOR_SAVE_BTN_');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAudioTeoriaSonnoRecordData(
