...
import 'sonno_ascolti_audio_text_editor_model.dart';
export 'sonno_ascolti_audio_text_editor_model.dart';

class SonnoAscoltiAudioTextEditorWidget extends StatefulWidget {
  const SonnoAscoltiAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AscoltiSonnoRecord? docMedita;

  @override
  State<SonnoAscoltiAudioTextEditorWidget> createState() =>
      _SonnoAscoltiAudioTextEditorWidgetState();
}

class _SonnoAscoltiAudioTextEditorWidgetState
    extends State<SonnoAscoltiAudioTextEditorWidget> {
  late SonnoAscoltiAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SonnoAscoltiAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SONNO_ASCOLTI_AUDIO_TEXT_EDITOR_DISMISS_');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SONNO_ASCOLTI_AUDIO_TEXT_EDITOR_SAVE_BTN');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAscoltiSonnoRecordData(
