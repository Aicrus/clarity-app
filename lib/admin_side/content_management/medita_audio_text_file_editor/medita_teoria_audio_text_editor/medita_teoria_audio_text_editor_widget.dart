...
import 'medita_teoria_audio_text_editor_model.dart';
export 'medita_teoria_audio_text_editor_model.dart';

class MeditaTeoriaAudioTextEditorWidget extends StatefulWidget {
  const MeditaTeoriaAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AudioTeoriaRecord? docMedita;

  @override
  State<MeditaTeoriaAudioTextEditorWidget> createState() =>
      _MeditaTeoriaAudioTextEditorWidgetState();
}

class _MeditaTeoriaAudioTextEditorWidgetState
    extends State<MeditaTeoriaAudioTextEditorWidget> {
  late MeditaTeoriaAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaTeoriaAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_TEORIA_AUDIO_TEXT_EDITOR_DISMISS_');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_TEORIA_AUDIO_TEXT_EDITOR_SAVE_BTN');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAudioTeoriaRecordData(
