...
import 'medita_ascolti_audio_text_editor_model.dart';
export 'medita_ascolti_audio_text_editor_model.dart';

class MeditaAscoltiAudioTextEditorWidget extends StatefulWidget {
  const MeditaAscoltiAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AscoltiMeditaRecord? docMedita;

  @override
  State<MeditaAscoltiAudioTextEditorWidget> createState() =>
      _MeditaAscoltiAudioTextEditorWidgetState();
}

class _MeditaAscoltiAudioTextEditorWidgetState
    extends State<MeditaAscoltiAudioTextEditorWidget> {
  late MeditaAscoltiAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaAscoltiAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_ASCOLTI_AUDIO_TEXT_EDITOR_DISMISS');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_ASCOLTI_AUDIO_TEXT_EDITOR_SAVE_BT');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAscoltiMeditaRecordData(
