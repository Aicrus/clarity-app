...
import 'medita_pratica_audio_text_editor_model.dart';
export 'medita_pratica_audio_text_editor_model.dart';

class MeditaPraticaAudioTextEditorWidget extends StatefulWidget {
  const MeditaPraticaAudioTextEditorWidget({
    super.key,
    required this.docMedita,
  });

  final AudioPraticaRecord? docMedita;

  @override
  State<MeditaPraticaAudioTextEditorWidget> createState() =>
      _MeditaPraticaAudioTextEditorWidgetState();
}

class _MeditaPraticaAudioTextEditorWidgetState
    extends State<MeditaPraticaAudioTextEditorWidget> {
  late MeditaPraticaAudioTextEditorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaPraticaAudioTextEditorModel());
        ...
        children: [
          ...
          Row(
            ...
            children: [
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_PRATICA_AUDIO_TEXT_EDITOR_DISMISS');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('MEDITA_PRATICA_AUDIO_TEXT_EDITOR_SAVE_BT');
                  logFirebaseEvent('Button_backend_call');

                  await widget.docMedita!.reference
                      .update(createAudioPraticaRecordData(
