...
import 'pot_pratiaca_audio_adder_model.dart';
export 'pot_pratiaca_audio_adder_model.dart';

class PotPratiacaAudioAdderWidget extends StatefulWidget {
  const PotPratiacaAudioAdderWidget({
    super.key,
  ...
  @override
  State<PotPratiacaAudioAdderWidget> createState() =>
      _PotPratiacaAudioAdderWidgetState();
}

class _PotPratiacaAudioAdderWidgetState
    extends State<PotPratiacaAudioAdderWidget> {
  late PotPratiacaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PotPratiacaAudioAdderModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'POT_PRATIACA_AUDIO_ADDER_SELEZIONARE_IL_');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'POT_PRATIACA_AUDIO_ADDER_AGGIUNGI_UN\'IM');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'POT_PRATIACA_AUDIO_ADDER_REGISTRARE_IL_C');
                      logFirebaseEvent('Button_backend_call');

                      var audioPraticaPotenziaRecordReference =
                          AudioPraticaPotenziaRecord.collection.doc();
                      await audioPraticaPotenziaRecordReference.set({
                        ...createAudioPraticaPotenziaRecordData(
                      ...
                      _model.listPotRef =
                          AudioPraticaPotenziaRecord.getDocumentFromData({
                        ...createAudioPraticaPotenziaRecordData(
                          title: _model.textController1.text,
                          length: _model.textController2.text,
                          index: int.tryParse(_model.textController3.text),
                      ...
                      }, audioPraticaPotenziaRecordReference);
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'POT_PRATIACA_AUDIO_ADDER_CHIUDERE_BTN_ON');
                      logFirebaseEvent('Button_bottom_sheet');
                      Navigator.pop(context);
                    },
                    text: 'Chiudere',
