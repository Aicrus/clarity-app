...
import 'pot_teoria_audio_adder_model.dart';
export 'pot_teoria_audio_adder_model.dart';

class PotTeoriaAudioAdderWidget extends StatefulWidget {
  const PotTeoriaAudioAdderWidget({
    super.key,
  ...
  @override
  State<PotTeoriaAudioAdderWidget> createState() =>
      _PotTeoriaAudioAdderWidgetState();
}

class _PotTeoriaAudioAdderWidgetState extends State<PotTeoriaAudioAdderWidget> {
  late PotTeoriaAudioAdderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PotTeoriaAudioAdderModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'POT_TEORIA_AUDIO_ADDER_SELEZIONARE_IL_FI');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'POT_TEORIA_AUDIO_ADDER_AGGIUNGI_UN\'IMMA');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'POT_TEORIA_AUDIO_ADDER_REGISTRARE_IL_CAP');
                        logFirebaseEvent('Button_backend_call');

                        var audioTeoriaPotenziaRecordReference =
                            AudioTeoriaPotenziaRecord.collection.doc();
                        await audioTeoriaPotenziaRecordReference.set({
                          ...createAudioTeoriaPotenziaRecordData(
                        ...
                        _model.listPotRef =
                            AudioTeoriaPotenziaRecord.getDocumentFromData({
                          ...createAudioTeoriaPotenziaRecordData(
                            title: _model.textController1.text,
                            length: _model.textController2.text,
                            index: int.tryParse(_model.textController3.text),
                        ...
                        }, audioTeoriaPotenziaRecordReference);
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'POT_TEORIA_AUDIO_ADDER_CHIUDERE_BTN_ON_T');
                        logFirebaseEvent('Button_bottom_sheet');
                        Navigator.pop(context);
                      },
                      text: 'Chiudere',
