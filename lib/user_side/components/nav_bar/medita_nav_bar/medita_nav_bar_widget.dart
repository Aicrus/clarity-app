...
import 'medita_nav_bar_model.dart';
export 'medita_nav_bar_model.dart';

class MeditaNavBarWidget extends StatefulWidget {
  const MeditaNavBarWidget({super.key});

  @override
  State<MeditaNavBarWidget> createState() => _MeditaNavBarWidgetState();
}

class _MeditaNavBarWidgetState extends State<MeditaNavBarWidget> {
  late MeditaNavBarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeditaNavBarModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MEDITA_NAV_BAR_COMP_medita_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MEDITA_NAV_BAR_COMP_sonno_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MEDITA_NAV_BAR_COMP_potenziamenti_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MEDITA_NAV_BAR_COMP_diario_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'MEDITA_NAV_BAR_COMP_impostazioni_ON_TAP');
