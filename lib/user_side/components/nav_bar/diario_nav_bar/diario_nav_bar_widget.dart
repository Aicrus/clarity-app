...
import 'diario_nav_bar_model.dart';
export 'diario_nav_bar_model.dart';

class DiarioNavBarWidget extends StatefulWidget {
  const DiarioNavBarWidget({super.key});

  @override
  State<DiarioNavBarWidget> createState() => _DiarioNavBarWidgetState();
}

class _DiarioNavBarWidgetState extends State<DiarioNavBarWidget> {
  late DiarioNavBarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DiarioNavBarModel());
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DIARIO_NAV_BAR_COMP_medita_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DIARIO_NAV_BAR_COMP_sonno_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DIARIO_NAV_BAR_COMP_potenziamenti_ON_TAP');
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DIARIO_NAV_BAR_COMP_diario_ON_TAP');
                            logFirebaseEvent('diario_navigate_to');

                            context.pushNamed('agendaForm');
                          },
                          child: Container(
                            width: 61.0,
                            height: 44.0,
                              ...
                              children: [
                                Container(
                                  ...
                                  child: SvgPicture.asset(
                                    Theme.of(context).brightness ==
                                            Brightness.dark
                                        ? 'assets/images/DIARIOGIALLO.svg'
                                        : 'assets/images/DIARIOGIALLO.svg',
                                    width: 20.0,
                                    height: 16.0,
                                    fit: BoxFit.contain,
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'DIARIO_NAV_BAR_COMP_impostazioni_ON_TAP');
