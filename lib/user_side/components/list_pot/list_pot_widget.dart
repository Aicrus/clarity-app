...
import 'list_pot_model.dart';
export 'list_pot_model.dart';

class ListPotWidget extends StatefulWidget {
  const ListPotWidget({
    super.key,
    required this.refPot,
  });

  final DocumentReference? refPot;

  @override
  State<ListPotWidget> createState() => _ListPotWidgetState();
}

class _ListPotWidgetState extends State<ListPotWidget> {
  late ListPotModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListPotModel());
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: 250.0,
                      decoration: const BoxDecoration(),
                      child: StreamBuilder<List<PotenziamentiRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<PotenziamentiRecord>
                              listViewPotenziamentiRecordList = snapshot.data!;
                          return ListView.separated(
                            padding: EdgeInsets.zero,
                            primary: false,
                            scrollDirection: Axis.horizontal,
                            itemCount: listViewPotenziamentiRecordList.length,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'LIST_POT_COMP_eraser_ICN_ON_TAP');
                                            logFirebaseEvent(
                                                'IconButton_backend_call');
                                            await listViewPotenziamentiRecord
                                                .reference
                                                .delete();
                                          },
                                        ),
