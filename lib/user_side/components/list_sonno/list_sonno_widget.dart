...
import 'list_sonno_model.dart';
export 'list_sonno_model.dart';

class ListSonnoWidget extends StatefulWidget {
  const ListSonnoWidget({
    super.key,
    required this.refSonno,
  });

  final DocumentReference? refSonno;

  @override
  State<ListSonnoWidget> createState() => _ListSonnoWidgetState();
}

class _ListSonnoWidgetState extends State<ListSonnoWidget> {
  late ListSonnoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListSonnoModel());
              ...
              itemBuilder: (context, listViewIndex) {
                ...
                return Column(
                  ...
                  children: [
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 20.0, 12.0),
                      child: Container(
                        width: double.infinity,
                        height: 34.0,
                    ...
                    Container(
                      ...
                      child: StreamBuilder<List<SonnoRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<SonnoRecord> listViewSonnoRecordList =
                              snapshot.data!;
                          return ListView.separated(
                            padding: EdgeInsets.zero,
                            primary: false,
                            scrollDirection: Axis.horizontal,
                            itemCount: listViewSonnoRecordList.length,
                            separatorBuilder: (_, __) => const SizedBox(width: 12.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewSonnoRecord =
                                  listViewSonnoRecordList[listViewIndex];
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Stack(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowIconButton(
                                          ...
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'LIST_SONNO_COMP_eraser_ICN_ON_TAP');
                                            logFirebaseEvent(
                                                'IconButton_backend_call');
                                            await listViewSonnoRecord.reference
                                                .delete();
                                          },
                                        ),
                                      ),
