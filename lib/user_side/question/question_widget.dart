              ...
              title: Row(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'QUESTION_PAGE_Icon_exy4d709_ON_TAP');
                  ...
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      logFirebaseEvent('QUESTION_PAGE_Image_ae42xqcg_ON_TAP');
                  ...
                  Column(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'QUESTION_PAGE_INVIA_FEEDBACK_BTN_ON_TAP');
                          ...
                          await FeedbackRecord.collection
                              ...
                              .set(createFeedbackRecordData(
                                ...
                                describe: _model.textController1.text,
                                object: _model.textController2.text,
                              ));
