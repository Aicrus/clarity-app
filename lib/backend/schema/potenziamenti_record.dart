...
class PotenziamentiRecord extends FirestoreRecord {
  PotenziamentiRecord._(
    super.reference,
    super.data,
  ) {
    _initializeFields();
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('Potenziamenti')
          : FirebaseFirestore.instance.collectionGroup('Potenziamenti');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('Potenziamenti').doc(id);

  static Stream<PotenziamentiRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => PotenziamentiRecord.fromSnapshot(s));

  static Future<PotenziamentiRecord> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => PotenziamentiRecord.fromSnapshot(s));

  static PotenziamentiRecord fromSnapshot(DocumentSnapshot snapshot) =>
      PotenziamentiRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static PotenziamentiRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      PotenziamentiRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'PotenziamentiRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is PotenziamentiRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createPotenziamentiRecordData({
  String? image,
  String? title,
  String? susubtitle,
  DateTime? createdAt,
...
class PotenziamentiRecordDocumentEquality
    implements Equality<PotenziamentiRecord> {
  const PotenziamentiRecordDocumentEquality();

  @override
  bool equals(PotenziamentiRecord? e1, PotenziamentiRecord? e2) {
  ...
  @override
  int hash(PotenziamentiRecord? e) => const ListEquality().hash([
        e?.image,
        e?.title,
        e?.susubtitle,
        e?.createdAt,
  ...
  @override
  bool isValidKey(Object? o) => o is PotenziamentiRecord;
}
